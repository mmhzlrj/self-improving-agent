...
| **主动执行** | 它推理出来了，直接做 | 你拿起外套，它就知道你要出门 — 顺便帮你把钥匙递到手边，然后跟我一起走出去，远程帮我把门锁打开 |
...
在 Cyber Tank 的移动能力基础上扩展室内移动能力，加入障碍识别和路径规划。通过**硬件拓展 kit** 接入智能家居设备，实现语音和自动化控制。这一步让 0-1 从「一个固定位置的机器人」变成「一个能在家里移动的陪伴者」，同时通过远程控制门锁等设备，在主人离家/到家时自动开关门。
